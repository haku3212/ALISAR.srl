    ...
    <div style={{ padding: '32px', color: '#e0e0e0' }}>
                  ...
                  <tr key={r.id} style={{ borderBottom: '1px solid #1f2937' }}>
                    ...
                    <td style={{ padding: '14px 16px' }}>
                      <div style={{ display: 'flex', gap: '8px' }}>
                        ...
                        <button onClick={() => requestDelete(r.id)} style={{ background: 'transparent', border: 'none', color: '#f87171', cursor: 'pointer', padding: '2px' }}><Trash2 size={16} /></button>
                      </div>
                    </td>
                  </tr>
                );
      ...
      <Modal isOpen={!!pendingDeleteId} onClose={cancelDelete} title="Confirmar Eliminación">
        <div style={{ textAlign: 'center', padding: '8px 0 24px' }}>
          <p style={{ color: '#e0e0e0', marginBottom: '24px' }}>¿Estás seguro de que deseas eliminar este rodeo? Esta acción no se puede deshacer.</p>
